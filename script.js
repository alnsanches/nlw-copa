function createGame(team1, hour, team2) {
    return `
    <li>
        <img src="./assets/flags/icon-${team1}.svg" alt="Bandeira do ${team1}" />
        <strong>${hour}</strong> 
        <img src="./assets/flags/icon-${team2}.svg" alt="Bandeira da ${team2}" />
    </li>`
}
...
document.querySelector("#app").innerHTML = `
        <header>
            <img class="logo" src="./assets/logo.svg" alt="Logo da NLW Copa">
        </header>  
            <main id="cards">
                ...
                ${createCard("29/11", "terça", createGame("ecuador", "12:00", "senegal") + createGame("netherlands", "12:00", "qatar") + createGame("iran", "16:00", "usa") + createGame("england", "16:00", "wales"))}
                ${createCard("30/11", "quarta", createGame("tunisia", "12:00", "france") + createGame("australia", "12:00", "denmark") + createGame("saudi arabia", "16:00", "mexico") + createGame("poland", "16:00", "argentina"))}
                ${createCard("01/12", "quinta", createGame("croatia", "12:00", "belgium") + createGame("morocco", "12:00", "canada") + createGame("costa rica", "16:00", "germany") + createGame("japan", "16:00", "spain"))}
